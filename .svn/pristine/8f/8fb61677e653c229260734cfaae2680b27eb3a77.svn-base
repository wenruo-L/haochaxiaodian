// pages/address_manage/address_manage.js
...
Page({
  ...
  redact_address: function(e) {
    wx.navigateTo({
      url: '../../pages/add_new_address/add_new_address?id=' + e.currentTarget.dataset.id + "&name=" + e.currentTarget.dataset.name + "&phone=" + e.currentTarget.dataset.phone,
      success: function(res) {},
    })
  },
  //删除地址
